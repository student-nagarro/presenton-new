...
export const layoutId = "bg-slide-02-cover";
export const layoutName = "Layout_bg_slide_02_cover";
export const layoutDescription = "bg-slide-02-cover (cover_dark)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie2.PNG"
  const safe = { left: "50%", top: "15%", right: "5%", bottom: "8%" }
