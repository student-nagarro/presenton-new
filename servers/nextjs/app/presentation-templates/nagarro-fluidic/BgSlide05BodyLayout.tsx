...
export const layoutId = "bg-slide-05-body";
export const layoutName = "Layout_bg_slide_05_body";
export const layoutDescription = "bg-slide-05-body (cover_light)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie5.PNG"
