...
export const layoutId = "bg-slide-13-split";
export const layoutName = "Layout_bg_slide_13_split";
export const layoutDescription = "bg-slide-13-split (bullets_light)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie13.PNG"
