...
export const layoutId = "bg-slide-04-cover";
export const layoutName = "Layout_bg_slide_04_cover";
export const layoutDescription = "bg-slide-04-cover (cover_light)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie4.PNG"
  const safe = { left: "5%", top: "17%", right: "5%", bottom: "8%" }
    ...
    >
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          zIndex: 1,
          color: "#0f172a" // dark text for light covers
        }}
      >
        <div style={{ padding: "40px", height: "100%", display: "flex", flexDirection: "column" }}>
          ...
          {metaLine ? (
            <div style={{ marginTop: "auto", paddingTop: "26px" }}>
              <p style={{ margin: 0, fontSize: "22px", opacity: 0.85, maxHeight: "60px", overflow: "hidden" }}>
                {metaLine}
              </p>
            </div>
          ) : null}
