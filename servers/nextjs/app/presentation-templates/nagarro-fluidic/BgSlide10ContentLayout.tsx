...
export const layoutId = "bg-slide-10-content";
export const layoutName = "Layout_bg_slide_10_content";
export const layoutDescription = "bg-slide-10-content (bullets_light)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie10.PNG"
  const safe = { left: "6%", top: "13%", right: "55%", bottom: "6%" }
