...
export const layoutId = "bg-slide-15-agenda";
export const layoutName = "Layout_bg_slide_15_agenda";
export const layoutDescription = "bg-slide-15-agenda (bullets_light)";
...
function RendererLayout({ data }) {
  const bgPath = "/static/images/nagarro_fluidic/Folie15.PNG"
